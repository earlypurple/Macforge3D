...
def demo_advanced_features():
    ...
    text = "Compression"
    original_mesh = create_text_mesh(
        text,
        font_size=72,
        depth=10,
        centered=True
    ...
    print(f"Taille originale: {len(original_mesh.vertices.tobytes() + original_mesh.faces.tobytes()):,} bytes")
    ...
    print("Vérification de l'intégrité:", np.allclose(original_mesh.vertices, decompressed_mesh.vertices))
