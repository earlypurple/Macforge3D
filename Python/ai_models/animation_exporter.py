...
class AnimationExporter:
    ...
    def _export_gltf(
        ...
        if self.settings.binary:
            ...
            gltf.buffers[0].uri = f"data:application/octet-stream;base64,{base64.b64encode(buffer_data + animation_buffer_data).decode('ascii')}"
    ...
    def _export_fbx(
        ...
        if not exporter.Initialize(
            str(output_path.with_suffix('.fbx')),
            -1,
