...
class TaskDistributor:
    ...
    def __init__(
        self, host: str = "0.0.0.0", port: int = 5555, discovery_port: int = 5556
    ):
        self.host = host
        self.port = port
    ...
    async def _handle_task_submission(self, message: Dict) -> Dict:
        ...
        if worker_id:
            ...
            return {"status": "error", "message": "Aucun worker disponible"}
    ...
    def _check_worker_capabilities(
        self, worker: WorkerInfo, task: DistributedTask
    ) -> bool:
