...
class ThermalSimulation:
    ...
    def solve(self) -> bool:
        ...
        try:
            ...
            for n in range(self.time_steps):
                ...
                if n % 10 == 0:
                    logger.info(
                        f"t = {t:.1f}s, T_max = {max(self.u.vector()[:]):.1f}°C"
                    )
    ...
    def get_results(self) -> Dict:
        ...
        try:
            ...
            time_above_glass = float(
                np.sum(times[max_temps > self.material.glass_transition])
            )
...
def simulate_thermal(
    ...
    try:
        ...
        sim = ThermalSimulation(
            mesh_path, material, initial_temp, ambient_temp, time_steps, simulation_time
        )
